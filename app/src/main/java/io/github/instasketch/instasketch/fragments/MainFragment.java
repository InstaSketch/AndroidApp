    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                startActivity(i);*/
                Intent searchIntent = new Intent(getActivity(), SearchActivity.class);
                searchIntent.putExtra(SearchActivity.INPUT_IS_SKETCH, true);

                searchIntent.putExtra(SearchActivity.INPUT_IMAGE_URI, Uri.parse(mSketchView.dumpToFile()));
                startActivity(searchIntent);
            }
        });
        ...
        sketchPalette.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                handleSketchPaletteAction(item);
                return false;
            }
        });
...
//    The methods below handle the launching of fragments upon tapping on icons in the sketch palette
    private void handleSketchPaletteAction(MenuItem item){
    ...
    private void changeColor() {
        ...
        colorPickerDialog.setOnColorSelectedListener(new ColorPickerFragment.onColorSelectedListener() {
            ...
            public void onColorSelected(int color) {
                mSketchView.setPaintColor(color);
            }
        });
