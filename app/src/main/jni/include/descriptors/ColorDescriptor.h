...
//    ColorDescriptor(int h_bins, int s_bins, int v_bins);
    ...
    static std::vector<float> describe_sketch(cv::Mat image, int h_bins, int s_bins, int v_bins, int threshold);
    ...
    static float compare_intersect(float hist1[], int hist1_size, float hist2[], int hist2_size);
